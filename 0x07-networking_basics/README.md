...
This project was the first of two introducing networking concepts. In this project, I answered a few quiz-like questions and wrote a couple bash scripts while learning about the OSI model, LAN and WAN networks, and TCP/UD P data transfer protocols.
Tasks
    ...
    1. Types of network
        ...
        What type of network could connect an office in one building to another office in a building a few streets away?
            ...
            WAN
            LAN
        What network do you use www.google.com from your smartphone (not connected to the Wifi)?
            Internet
            WAN
            LAN
